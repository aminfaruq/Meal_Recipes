...
import co.id.aminfaruq.core.data.source.remote.response.DetailMealsItem
import co.id.aminfaruq.core.domain.model.DetailMeal

class ItemDetailMapper :
    BaseMapper<DetailMealsItem, DetailMeal> {
    override fun mapToDomain(model: DetailMealsItem): DetailMeal {
        return DetailMeal(
    ...
    override fun mapToModel(domain: DetailMeal): DetailMealsItem {
        return DetailMealsItem(
